...
class CustomUtils {
  void goTo(String route, BuildContext context) {
    try {
      ...
      debugPrint('Não foi possível ir para a rota $route');
    }
  }
  ...
  void goToBack(BuildContext context) {
    try {
      ...
      debugPrint('Não foi possível voltar para página anterior');
    }
  }
  ...
  void shareRachaRacha() {
    try {
      ...
      debugPrint("Não foi possível compartilhar o app :( ");
    }
  }
  ...
  Future goToUrl(String url) async {
    try {
      ...
      debugPrint("Não foi possível ur para $url");
    }
  }
}
